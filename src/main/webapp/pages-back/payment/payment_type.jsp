						...
						<tbody id="tbl_income" class="row_position">
							<c:forEach var="test" items="${ paymentTypeList1}">
								...
								<tr>
									...
									<td id="${test.payment_type_id}"
										style="text-align: left; padding-top: 10px;">${test.payment_type_id}</td>
									<td style="text-align: left; padding-top: 10px;">${test.payment_type_name}</td>
									<td style="text-align: right;"><c:if
											test="${test.system == 1 }">
											<a
												class="btn btn-outline-danger sred-intense sweet-${test.payment_type_id}"
												title="Delete"
