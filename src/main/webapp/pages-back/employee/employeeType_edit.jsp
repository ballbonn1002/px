              ...
              <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> ประเภทการจ้าง</h2>
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">ประเภทการจ้าง</li>
                     <li class="breadcrumb-item active">เเก้ไขประเภทการจ้าง</li>
                </ul>
        </div>            
    </div>
</div>
            	...
            	<div class="portlet light bordered">
					<div class="portlet-title" style = "padding-bottom: 40px;">
						...
						<!--  <i class="fa fa-paperclip font-red"></i>-->
						 	<span class="caption-subject font-red sbold uppercase" style="font-weight: bold; font-size: 18px" >เเก้ไขประเภทการจ้าง</span>
						</div>
						<!--  <div class="actions">
					...
					<div class="panel-body">
						...
						<!-- End Hidden -->
							...
							<div class="form-group form-lg-line-input col-md-12">
								<label class="control-label col-md-3" id="namelabel">ID : </label>
							<div class="col-md-12">
								<input type="text" name="employee_type_id" class="form-control" id="employee_type_id"
								maxlength="240" value="${emptypeList.employee_type_id}" required> <input
							...
							<div class="form-group form-lg-line-input col-md-12">
								<label class="col-md-3 control-label" for="form_control_1">ประเภทการจ้าง : </label>
								<div class="col-md-12">
									<input type="text" name="name" class="form-control" id="name"
									maxlength="240" value="${emptypeList.name}" required>
								<div class="form-control-focus"></div>
								<!-- <span class="help-block">Please fill the information</span> -->
								</div>
							</div>
