    ...
    <div class="col-lg-12">
       ...
       <div class="portlet-body">
		<div class="panel-body">
        	<form action="add_empType" method="POST" autocomplete="off">
        	<div class="container">
        		<div class="row">
        		<div class="col-12" style="display:none;">
        				<div class="form-group">
        						<input type="text" id="i" name="id" class="form-control" value="">
        					</div>
        			</div>
        			<div class="col-12">
        				<div class="form-group">
        				...
        				<label for="recipient-name" class="control-label">ประเภทการจ่ายเงิน<span style="color:red;"> *</span></label><br><br>
        					 	<div class="form-group">
        							<label class="fancy-radio custom-color-green">
                                        <input type="radio" name="payment" value="0"><span><i></i>&nbsp;รายเดือน</span>
                                     </label>
                                     <label class="fancy-radio custom-color-green">
                                        <input type="radio" name="payment" value="1"><span><i></i>&nbsp;รายวัน</span>
                                    </label>
                                 </div>  
        			</div>
        			<div class="col-6">
        				<div class="form-group">
        					...
        					<c:forEach var="s" begin="1" end="4">
        							<option value='${s}'><c:out value="${s}"/>&nbsp;งวด</option>
        						</c:forEach>
        					</select>
        				</div>	
        			</div>
        				...
        				<div class="form-group">
        					...
        					<select id="" class="form-control show-tick ms search-select" name="term_day">
        						<c:forEach var="i" begin="1" end="31">
        							<option value='${i}'><c:out value="${i}"/>&nbsp;วันทำงานจริง</option>
        						</c:forEach>
        					</select>
        				</div>
        			</div>
        			<div class="col-12">
        				<div class="form-group">
        					...
        					<div class="input-group">
        						<input type="text" id="" name="description" class="form-control" value="${emptypeList.description}">
        					</div>
        				</div>
        			</div>
        		</div>	
