...
<div class="block-header">
	<div class="row">
    	<div class="col-lg-6 col-md-8 col-sm-12">
      		<h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Position</h2>
            	<ul class="breadcrumb">
										...
										<tbody>
					 						<c:forEach var="test" items="${positionList}">
												...
												<tr> 
													...
													<td style="padding-top: 10px;"><fmt:formatDate value="${test.time_create}" pattern=" dd-MM-yyyy" /></td>
													<td style="padding-top: 10px;"><fmt:formatDate value="${test.time_update}" pattern=" dd-MM-yyyy" /></td>
													--%>
													<td style="text-align:right;">                                            
				                                        <a class="btn btn-outline-success" title="Edit" href="editPosition?position_id=${test.position_id}">
				                                        <i class="fa fa-pencil"></i></a>
				                                        <a class="btn btn-outline-danger sweet-${test.position_id}" title="Delete" onclick="_gaq.push(['_trackEvent', 'example', 'try', 'Primary']);">
