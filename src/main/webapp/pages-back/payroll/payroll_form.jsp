			...
			<form>
				...
				<div class="row">
					<div class="col-12">
						...
						<div class="form-group">
							<input class="form-control" value="ทำเงินเดือนวันที่ 25/4/2022" />
						</div>
					</div>
				</div>
				<div class="clearfix mt-1 mb-1">
					<button type="button" class="btn btn-success  float-right m-2">บันทึกรายการ</button>
					<button type="button" class="btn btn-light  float-right m-2">ยกเลิก</button>
				</div>
			</form>
		</div>
	</div>
